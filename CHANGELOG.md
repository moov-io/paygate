...
Also included are [filename templates](#TODO(adam):::) for merged ACH files uploaded to an ODFI. This allows banks with specific rules for files to be used with paygate.
