...
@return MicroDepositAmounts
*/
func (a *AdminApiService) GetMicroDeposits(ctx _context.Context, depositoryId string) (MicroDepositAmounts, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  MicroDepositAmounts
	)
