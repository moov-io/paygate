...
func (c *fileTransferController) processMicroDepositReturn(requestID, userID string, depID internal.DepositoryID, md *internal.MicroDeposit, depRepo internal.DepositoryRepository, code *ach.ReturnCode) error {
