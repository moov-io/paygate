...
*/
func (a *TransfersApiService) UpdateTransferStatus(ctx _context.Context, transferId string, xUserID string, updateTransferStatus UpdateTransferStatus, localVarOptionals *UpdateTransferStatusOpts) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPut
		localVarPostBody     interface{}
		localVarFormFileName string
