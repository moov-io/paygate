...
type Client interface {
	...
	Lookup(customerID string, requestID string, namespace string) (*moovcustomers.Customer, error)
	...
	LatestOFACSearch(customerID, requestID string, namespace string) (*OfacSearch, error)
	RefreshOFACSearch(customerID, requestID string, namespace string) (*OfacSearch, error)
}
...
func (c *moovClient) Lookup(customerID string, requestID string, namespace string) (*moovcustomers.Customer, error) {
	ctx, cancelFn := context.WithTimeout(context.TODO(), 10*time.Second)
	defer cancelFn()
...
func (c *moovClient) LatestOFACSearch(customerID, requestID string, namespace string) (*OfacSearch, error) {
	ctx, cancelFn := context.WithTimeout(context.TODO(), 10*time.Second)
	defer cancelFn()
...
func (c *moovClient) RefreshOFACSearch(customerID, requestID string, namespace string) (*OfacSearch, error) {
	ctx, cancelFn := context.WithTimeout(context.TODO(), 10*time.Second)
	defer cancelFn()
