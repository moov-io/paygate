...
func (r *MockRepository) getUserTransfers(tenantID string, params transferFilterParams) ([]*client.Transfer, error) {
	if r.Err != nil {
		return nil, r.Err
	}
...
func (r *MockRepository) WriteUserTransfer(tenantID string, transfer *client.Transfer) error {
	return r.Err
}

func (r *MockRepository) deleteUserTransfer(tenantID string, transferID string) error {
	return r.Err
}
