...
func createPPDBatch(id, userId string, keeperFactory secrets.SecretFunc, transfer *Transfer, receiver *Receiver, receiverDep *Depository, orig *Originator, origDep *Depository) (ach.Batcher, error) {
